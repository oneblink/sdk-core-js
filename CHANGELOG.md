...
- `api.powerplatform.com` domain to power automate webhook subscriptions
...
- payment display detail key values to be unique across payment providers

## [8.8.0] - 2025-08-29

### Added

- support for `requiresAllConditionallyShowOptionsPredicates` in options elements

## [8.7.0] - 2025-08-11

### Added

- support for `CHECKBOXES`,`DROPDOWN`,`DATE`,`DATETIME` types to `goodToGoService`
